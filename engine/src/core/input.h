...
typedef enum buttons {
	...
	BUTTON_MAX_BUTTONS /**< Maximum number of mouse buttons. */
} buttons;
...
typedef enum keys {
	...
	KEYS_MAX_KEYS /**< Maximum number of keyboard keys. */
} keys;
...
/**
 * @brief Checks if a specific key is currently up.
 *
 * @param key The key to check.
...
/**
 * @brief Checks if a specific key was down in the previous frame.
 *
 * @param key The key to check.
...
/**
 * @brief Checks if a specific key was up in the previous frame.
 *
 * @param key The key to check.
...
/**
 * @brief Processes the state of a key.
 *
...
// Mouse input
/**
 * @brief Checks if a specific mouse button is currently down.
 *
...
/**
 * @brief Checks if a specific mouse button is currently up.
 *
 * @param button The mouse button to check.
...
/**
 * @brief Checks if a specific mouse button was down in the previous frame.
 *
 * @param button The mouse button to check.
 * @return True if the button was down in the previous frame, false otherwise.
 */
VAPI b8 input_was_button_down( buttons button );

/**
 * @brief Checks if a specific mouse button was up in the previous frame.
 *
 * @param button The mouse button to check.
 ...
 *
 * @param x Pointer to store the previous x-coordinate.
 * @param y Pointer to store the previous y-coordinate.
 */
VAPI void input_get_previous_mouse_position( i32* x, i32* y );

/**
 * @brief Processes the state of a mouse button.
 *
 * @param button The mouse button to process.
 ...
 *
 * @param z_delta The change in the wheel position.
 */
