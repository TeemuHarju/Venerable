...
/**
 * @brief Struct representing the context data for an event.
 *
 * The struct contains a union with different data types to hold event context.
 */
...
/**
 * @brief Enumeration representing system internal event codes.
 *
 * Application should use codes beyond 255.
 */
typedef enum system_event_code {
	EVENT_CODE_APPLICATION_QUIT = 0x01, /**< Shuts the application down on the next frame. */
	...
	MAX_EVENT_CODE = 0xFF /**< Maximum event code value. */
} system_event_code;